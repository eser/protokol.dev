...
## Proje ve takım dinamikleri
Takım işbirliği, iletişim ve yönetim pratiği ile ilgili başlıkları içerir.

- [Agile development](agile-development.md)
- [Career framework](career-framework.md)
- [Codeowners](codeowners.md)
- [Coffee talks](coffee-talks.md)
- [Cross-functional teams](cross-functional-teams.md)
- [Daily scrums](daily-scrums.md)
...
- [Pizza teams](pizza-teams.md)
- [Postmortems](postmortems.md)
- [Pulse surveys](pulse-surveys.md)
...
- [Business values](business-values.md)
...
Yazılımın dağıtımı ve sürekli entegrasyonu gibi teknik süreçleri kapsar.
...
- [Service tracing](service-tracing.md)
- [Static code analysis](static-code-analysis.md)
- [Trunk based development](trunk-based-development.md)

## Yazılım ustalığı
Yazılımın kalitesini ve mühendislerin uzmanlığını artırma yöntemlerine odaklanır.

- [Architectural design records](architectural-design-records.md)
- [Command query separation](command-query-separation.md)
- [Determinism](determinism.md)
- [Engineering plans](engineering-plans.md)
